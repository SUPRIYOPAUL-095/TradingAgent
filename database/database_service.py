...
def store_agent_reports(analysis_id):
    ...
    for agent, report in agent_reports.items():
        if report:
            ...
            execute_query(query, (company, analysis_date, agent, report_data, analysis_id))

def process_results(company_symbol, analysis_date, final_decision, analysis_id):
    query = """
    ...
    execute_query(query, (company_symbol, analysis_date, final_decision, analysis_id))